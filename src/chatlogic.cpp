...
ChatLogic::~ChatLogic()
{
    ...
    //{
        // Old code - TODO: verify that delete is no longer needed
        //delete *it;   
   // }
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // _edges.push_back(edge.get()); // No longer needed
    ...
    this->SetChatbotHandle(&new_chatBot);
