...
ChatBot::ChatBot() {
  std::cout << "ChatBot - Constructor (w/o memory allocation - for node creation))\n";
...
ChatBot::~ChatBot() {
  ...
  if (_image != NULL) // Attention: wxWidgets used NULL and not nullptr
  {
    delete _image;
    _image = NULL;
    std::cout << "(the actual chatbot)";
  }
  else{
    std::cout << "(an empty handle)";
  }
  std::cout << std::endl;
}
...
ChatBot::ChatBot(const ChatBot &source) {
  ...
  _chatLogic->SetChatbotHandle(this); // TODO: Check if it works
};
// Move constructor
...
ChatBot &ChatBot::operator=(const ChatBot &source) {
  ...
  return *this; // TODO: Check if with or without *
}
